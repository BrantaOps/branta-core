...
import { getAllAddresses, queryBalance, verifyAddress, verifyXpub } from './lib/verify-address.js';
...
function createWindow() {
    ...
    ipcMain.handle('query-balance', async (_event, address) => await queryBalance(address));
